...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Thinktank: UK Should Privatise the Pound and Embrace Cryptocurrency     Coindesk 19.06.14 ";
        CTransaction txNew;
        txNew.nTime = 1403186908;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1403186908;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 897145;
        if(fTestNet)
        {
			txNew.nTime = 1403259118;
			block.nTime    = 1403259118;
            block.nNonce   = 11692;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("dad1a345035322ea18d8e4db1d0fdb56c7ce7fbccb7cdecbf7645bfc6bf1bc62"));
        block.print();
